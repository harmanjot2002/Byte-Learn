...
const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_z5tdas4', 'template_kwea3ej', form.current, 'NRDJ1PoPQXmwHx3LB')
      .then((result) => {
      ...
      <section className="contact" id="contact" style={{zIndex:20}}>
        ...
        <form onSubmit={handleSubmit} ref={form}>
            <div className="input-box">
                <input type="text" name="username" placeholder="Full Name" value={formData.username} autoComplete="none" onChange={handleChange} required/>
