...
//         </li>
//         {loggedInUser?(<li>
//             <NavLink  to="/register"className="btn1" target="_blank" rel="noreferrer">Logout<FiLogIn size={20} style={{color:'#fff'/*,marginLeft:"1rem",marginBottom:"-0.2rem" */,cursor:"pointer"}}/></NavLink>
//         </li>):(<li>
