          ...
          <div className="slide-content">
            <div className="grid-container">
              ...
              <div className="text-column">
                <h2>Rahul Kumar</h2>
                <h5>CS @Adobe, Instructor @Code-Help</h5>
                <p>Rahul Kumar is an ace software engineer working in the role of <strong>Computer Scientist</strong> at <strong>Adobe Systems</strong> and a popular computer science instructor on <strong>CodeHelp</strong> Youtube.He is working in the industry for the past <strong>4.5 years</strong>, working on different real-world problems. He is well-known among students for his amazingly simplified explanations with real-life examples, enabling students to understand complex topics very easily. Many of his ex-students are now working in top product companies like <strong>Microsoft, Amazon, De-Shaw</strong> etc.</p>
              </div>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="slide-content">
            <div className="grid-container">
              ...
              <div className="text-column">
                <h2>Sonali Singh</h2>
                <h5>Founder - Code-Help, Ex-Amazon, Ex-Microsoft</h5>
